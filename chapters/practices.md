...
* Beware making estimates or predictions that rely on a random sample of "controls" (as those in N3C are
  [matched to confirmed COVID-19 cases within data partner by age, sex, & race/ethnicity](https://github.com/rwdcollaborative/Phenotype_Data_Acquisition/wiki/Phenotype-3.0---Additional-Information))
...
|                                                | - Eligible Cohort Entry Period                   | - Link to [N3C Phenotype Description](https://github.com/rwdcollaborative/Phenotype_Data_Acquisition/wiki/Latest-Phenotype)   |
